...
//			return {semantic: rel.r_semantic, rel_name: rel.rel_name};
	...
	hasRelationship: function(source_class_name, target_class_name, both) {
		if (ea.relationships_index[source_class_name+target_class_name]) { return true; }
		if (both && ea.relationships_index[target_class_name+source_class_name]) { return true; }
		return false;
	}
};
ea.class_name = {
