...
ea.classBelongsToArea = {
	...
	,Application_Service: {area: 'Application', area_code: 'a', layer: 'Logical', icon:'flash', children_name: 'children'}
	,Application_Function: {area: 'Application', area_code: 'a', layer: 'Logical', icon:'flash', children_name: 'children'}
	...
	,Business_Actor: {area: 'Business', area_code: 'b', layer: 'Logical', icon:'flash', children_name: 'children'}
	...
	,Business_Function: {area: 'Business', area_code: 'b', layer: 'Logical', icon:'flash', children_name: 'children'}
	,Business_Process: {area: 'Business', area_code: 'b', layer: 'Logical', icon:'flash', children_name: 'children'}
	,Business_Event: {area: 'Business', area_code: 'b', layer: 'Logical', icon:'flash', children_name: 'children'}
	,Business_Service: {area: 'Business', area_code: 'b', layer: 'Logical', icon:'flash', children_name: 'children'}
	,Business_Object: {area: 'Business', area_code: 'b', layer: 'Logical', icon:'flash', children_name: 'children'}
	,Business_Location: {area: 'Business', area_code: 'b', layer: 'Logical', icon:'flash', children_name: 'children'}
	...
	,Technology_Function: {area: 'Technology', area_code: 't', layer: 'Logical', icon:'flash', children_name: 'children'}
	,Technology_Service: {area: 'Technology', area_code: 't', layer: 'Logical', icon:'flash', children_name: 'children'}
	,Technology_Node: {area: 'Technology', area_code: 't', layer: 'Logical', icon:'flash', children_name: 'children'}
	...
	,Motivation_Driver: {area: 'Motivation', area_code: 't', layer: 'Logical', icon:'flash', children_name: 'children'}
	//,Motivation_Assessment: {area: 'Motivation', area_code: 't', layer: 'Logical', icon:'flash', children_name: 'children'}
	,Motivation_Goal: {area: 'Motivation', area_code: 't', layer: 'Logical', icon:'flash', children_name: 'children'}
	,Motivation_Principle: {area: 'Motivation', area_code: 't', layer: 'Logical', icon:'flash', children_name: 'children'}
	,Motivation_Requirement: {area: 'Motivation', area_code: 't', layer: 'Logical', icon:'flash', children_name: 'children'}
	,Motivation_Constraint: {area: 'Motivation', area_code: 't', layer: 'Logical', icon:'flash', children_name: 'children'}
