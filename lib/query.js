...
diagramQuery = function(searchText, status) {
	return tdocQuery(searchText, status);
};
glossaryQuery = function(searchText, status) {
	return tdocQuery(searchText, status);
};
tableQuery = function(searchText, status) {
	return tdocQuery(searchText, status);
};
projectQuery = function(searchText, status) {
	return tdocQuery(searchText, status);
};
